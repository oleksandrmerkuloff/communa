...
class TagAPITest(APITestCase):
    ...
    def test_list_tags(self):
        Tag.objects.create(name="Finance", organization=self.organization)
    ...
    def test_update_tag(self):
        tag = Tag.objects.create(name="Finance", organization=self.organization)

        response = self.client.patch(f"/api/news/tags/{tag.id}/", {"name": "Updated"})
    ...
    def test_delete_tag(self):
        ...
        response = self.client.delete(f"/api/news/tags/{tag.id}/")
