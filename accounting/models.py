...
class Income(TimestampMixin):
    ...
    organization = models.ForeignKey(
        Organization, related_name="incomes", on_delete=models.CASCADE
    )
...
class Expense(TimestampMixin):
    id = models.UUIDField(editable=False, primary_key=True, default=uuid.uuid4)
    organization = models.ForeignKey(
        Organization, related_name="expenses", on_delete=models.CASCADE
    )
    category = models.ForeignKey(
...
class Budget(TimestampMixin):
    ...
    organization = models.ForeignKey(
        Organization, related_name="budgets", on_delete=models.CASCADE
    )
    category = models.ForeignKey(
